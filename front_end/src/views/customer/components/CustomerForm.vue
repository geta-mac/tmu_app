<template>
  <el-form ref="form" :model="form" :rules="rules" label-width="120px">
    ...
    <el-form-item :label="$t('customer.nickname')">
    ...
    <el-form-item :label="$t('customer.password_confirmation')">
      <el-input v-model="form.password_confirmation" />
    </el-form-item>
    <el-form-item :label="$t('customer.url')" prop="url">
      <el-input v-model="form.url" type="textarea" />
    </el-form-item>
    <el-form-item :label="$t('customer.club_id')">
      <el-select v-model="form.club_id" placeholder="Select">
        <el-option label="学生自治会 執行委員会" value="2" />
        <el-option label="学生ホール管理運営委員会" value="3" />
        <el-option label="体育会本部" value="4" />
        <el-option label="文化部本部" value="5" />
      </el-select>
    </el-form-item>
    <el-form-item>
